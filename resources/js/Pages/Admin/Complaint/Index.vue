            ...
            <div class="border border-gray-200 rounded-lg overflow-x-auto">
                <table class="text-center text-medium">
                    ...
                    <tr>
                        ...
                        <th class="p-2 text-gray-700">Текст</th>
                        <th class="p-2 text-gray-700">Пользователь</th>
                        <th class="p-2 text-gray-700">Ссылка(Сообщение)</th>
                        <th class="p-2 text-gray-700">Статус</th>
                        <th class="p-2 text-gray-700">Действия</th>
                    </tr>
                    </thead>
                    <tbody>
